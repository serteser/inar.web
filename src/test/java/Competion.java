 ...
 */
public class Competion extends Hooks {
    ...
    public void webAutomation() {
        ...
        actions.keyDown(Keys.CONTROL).click(itemList.get(0)).click(itemList.get(2)).keyUp(Keys.CONTROL).build().perform();
        ...
        actions.clickAndHold(itemList.get(0)).moveToElement(itemList.get(1)).moveToElement(itemList.get(2)).release().build().perform();
